...
export class NodejsFunctionWithRole extends Construct {
  ...
  constructor(
    ...
    const lambdaFunction = new nodeLambda.NodejsFunction(this, "Func", {
      entry: props.entry,
      ...
      [
        {
          ...
          reason:
            "This role is customer managed and uses a least-priviledge policy. The use of *'s is required for lambda to log properly.",
        },
      ],
      true
    );
